...
const handleConfirmDelete = () => {
    ...
    fetchWithAuth(`http://localhost:5000/api/personnels/${recordToDelete.idpers}`, {
      method: 'DELETE',
    })
      .then(() => {
    ...
    <div className={styles.personnels}>
      <div className={styles.break}>
        <Breadcrumb
          ...
          items={[
            { title: <a href="" style={{ fontSize: 19 }}>Personnels</a> },
            { title: <a href="" style={{ fontSize: 19 }}>Listes</a> }
          ]}
        />
        <div className={styles.listes}><h1>Liste personnels</h1></div>
      </div>
...
>
 ...
 <label htmlFor="id
     " style={{fontSize : 16 ,color :"#676767"}}>Voulez-vous vraiment supprimer ce personnel ?
