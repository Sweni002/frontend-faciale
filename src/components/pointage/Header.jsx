...
const {fetchMe}=useContext(AuthContext)
 ...
 useEffect(() => {
  ...
  <ul>
    {/* ✅ Admin : pas de tableau de bord */}
    {admin?.role === "Admin" && (
      <>

        <li onClick={openResponsable}>Responsables</li>
        <li onClick={openConge}>Absence</li>
         <li className={`${styles.iconWrapper}`}>
          <span className={darkMode ? styles.darkText : ""}>Autres</span>
          <i className={`fa-solid fa-chevron-down ${darkMode ? styles.iconDark : ""}`} 
    ...
    {/* ✅ Responsable : seulement Personnels */}
